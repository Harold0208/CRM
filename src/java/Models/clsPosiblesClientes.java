...
public class clsPosiblesClientes {
    ...
    public clsFuentePosibeCliente getObclsFuentePosibeCliente() {
        return obclsFuentePosibeCliente;
    }

    public void setObclsFuentePosibeCliente(clsFuentePosibeCliente obclsFuentePosibeCliente) {
        this.obclsFuentePosibeCliente = obclsFuentePosibeCliente;
    }
    ...
    public clsFuentePosibeCliente obclsFuentePosibeCliente;
    ...
    public void setStWeb(String parameter) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void setObclsCalificacion() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public void getInCantidadEmpleados(int parseInt) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
