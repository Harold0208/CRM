<%-- 
    Document   : Register
    Created on : 3/12/2020, 12:49:29 AM
    Author     : darkb
--%>
          ...
          <div class="form-group">
            ...
            <div class="form-row">
             <div class="col-md-6">
                ...
                <input class="form-control" name="txtPrimerNombre" type="text"  placeholder="Ingrese nombre">
              </div> 
                <div class="col-md-6">
                <label for="lblSegundoNombre">Segundo nombre</label>
                <input class="form-control" name="txtSegundoNombre" type="text"  placeholder="Ingrese nombre">
              </div>
            </div>
          </div>
            <div class="form-group">
            <div class="form-row">
             <div class="col-md-6">
                ...
                <input class="form-control" name="txtPrimerApellido" type="text"  placeholder="Ingrese apellido">
              </div> 
                <div class="col-md-6">
                <label for="lblSegundoApellido">Segundo apellido</label>
                <input class="form-control" name="txtSegundoApellido" type="text"  placeholder="Ingrese apellido">
              </div>
            </div>
          </div>
            <div class="form-group">
            ...
            <div class="form-row">
             <div class="col-md-6">
                ...
                <div class="col-md-6">
                <label for="lblTelefono">Confirmar password</label>
